...
import { navItems } from "@/components/shared/navigationConfig";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom Section with Actions and User Menu */}
        <div className="p-4 border-t border-sidebar-border space-y-3">
          ...
          <UserMenuDropdown
            triggerClassName="w-full justify-start gap-3 h-auto py-2"
          />
        </div>
      </aside>
